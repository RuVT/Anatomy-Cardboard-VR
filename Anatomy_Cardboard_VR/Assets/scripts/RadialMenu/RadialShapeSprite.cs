...
public class RadialShapeSprite {
	public GameObject button;
	public float deg_i, deg_f, ri, re;
	public int size;

	public static Sprite GenerateRadialShape(float deg_i, float deg_f, float ri, float re){
	...
	public static float GetAngle(float x, float y, float h, float k, float r){
		float angY = 0;
